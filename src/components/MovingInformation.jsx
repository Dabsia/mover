              ...
              <div className="mb-3 elevatorContainer flex">
                <div className="flex eleInnerBox mb-[10px] mr-4 flex-col">
                  ...
                  <div className="flex w-[200px] elevatorQuestionBox h-[45px] border-[1px] rounded-[8px] border-[#e3e3e3] items-center">
                    ...
                    >
                      <div
                        className={`flex w-[100%] ${fromBuildingInsuranceYes ? "bg-[#E4F0FC]" : ""
                          } rounded-tl-[8px] rounded-bl-[8px] h-full border-r-[1px] justify-center border-[#e3e3e3] items-center `}
                      >
                        <input
                          type="radio"
                    ...
                    >
                      <div
                        className={`flex items-center justify-center h-full w-[100%] ${fromBuildingInsuranceNo ? "bg-[#E4F0FC]" : ""
                          }`}
                      >
                        <input
                          type="radio"
              ...
              <div className="mb-3 elevatorContainer flex">
                <div className="flex eleInnerBox mb-[10px] mr-4 flex-col">
                  ...
                  <div className="flex w-[200px] elevatorQuestionBox h-[45px] border-[1px] rounded-[8px] border-[#e3e3e3] items-center">
                    ...
                    >
                      <div
                        className={`flex w-[100%] ${toBuildingInsuranceYes ? "bg-[#E4F0FC]" : ""
                          } rounded-tl-[8px] rounded-bl-[8px] h-full border-r-[1px] justify-center border-[#e3e3e3] items-center `}
                      >
                        <input
                          type="radio"
                    ...
                    >
                      <div
                        className={`flex items-center justify-center h-full w-[100%] ${toBuildingInsuranceNo ? "bg-[#E4F0FC]" : ""
                          }`}
                      >
                        <input
                          type="radio"
